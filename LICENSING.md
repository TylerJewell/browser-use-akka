...
A `LICENSE-browser-use` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [browser-use/browser-use](https://github.com/browser-use/browser-use), Copyright
2024 Gregor Zunic, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../browser-use-port/specs/SPEC-001-browser-use.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
